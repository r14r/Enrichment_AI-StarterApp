...
with st.expander("🔧 Basic Usage"):
    ...
    with col1:
        st.markdown("**Code:**")
        CODE = helper_streamlit.get_code("ollama_basics/basic_chat.py")
...
with st.expander("📡 Streaming Responses"):
    ...
    with col1:
        st.markdown("**Code:**")
        CODE = helper_streamlit.get_code("ollama_basics/streaming.py")
        st.code(CODE, language="python")
        helper_streamlit.run_code(CODE)
...
with st.expander("✨ Generate API"):
    ...
    with col1:
        st.markdown("**Code:**")
        CODE = helper_streamlit.get_code("ollama_basics/generate.py")
        st.code(CODE, language="python")
        helper_streamlit.run_code(CODE)
...
with st.expander("🗂️ Model Management"):
    ...
    CODE = helper_streamlit.get_code("ollama_basics/list_models.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
    
    st.markdown("**Pull a Model:**")
    CODE = helper_streamlit.get_code("ollama_basics/pull_model.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
    
    st.markdown("**Delete a Model:**")
    CODE = helper_streamlit.get_code("ollama_basics/delete_model.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
...
with st.expander("⚙️ Advanced Parameters"):
    ...
    CODE = helper_streamlit.get_code("ollama_basics/advanced_parameters.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
...
with st.expander("💬 System Messages"):
    ...
    with col1:
        st.markdown("**Code:**")
        CODE = helper_streamlit.get_code("ollama_basics/system_messages.py")
        st.code(CODE, language="python")
        helper_streamlit.run_code(CODE)
...
with st.expander("🛡️ Error Handling"):
    ...
    CODE = helper_streamlit.get_code("ollama_basics/error_handling.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
...
with col2:
    st.markdown("**Code:**")
    CODE = helper_streamlit.get_code("ollama_basics/check_ollama_status.py")
    st.code(CODE, language="python")
    helper_streamlit.run_code(CODE)
